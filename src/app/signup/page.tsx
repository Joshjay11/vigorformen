...
export default function SignupPage() {
  ...
  const handleAuthStateChange = (currentUser: User | null) => {
    ...
    // Redirect to members area after successful signup
    if (currentUser) {
      router.push('/members');
    }
  };
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-md mx-auto">
        ...
        <p className="mb-8 text-secondary-600 dark:text-secondary-400">
          Join VigorForMen to access exclusive content, personalized recommendations, and connect with a community of like-minded men focused on health and wellness.
        </p>
